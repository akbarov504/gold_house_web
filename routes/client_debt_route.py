...
from forms.client_debt_form import CreateClientDebtForm, UpdateClientDebtForm
...
@app.route("/client_debt/update/<client_debt_id>", methods=["GET", "POST"])
@login_required
def client_debt_update_page(client_debt_id):
    ...
    if form.validate_on_submit():
        ...
        update_client_debt.client = client
        ...
        return render_template("client_debt/client_debt_update.html", form=form, client_debt_id=client_debt_id)
